...
@extend_schema_view(
    create=extend_schema(
        ...
        responses={
            ...
            status.HTTP_404_NOT_FOUND: OpenApiResponse(description='Redirect rule wasn\'t found.'),
        },
    ),
    ...
    destroy=extend_schema(
        ...
        responses={
            status.HTTP_204_NO_CONTENT: OpenApiResponse(description='Redirect rule was successfully deleted.'),
            status.HTTP_401_UNAUTHORIZED: OpenApiResponse(description='User is not authenticated.'),
            status.HTTP_404_NOT_FOUND: OpenApiResponse(description='Redirect rule wasn\'t found.'),
        },
    ),
